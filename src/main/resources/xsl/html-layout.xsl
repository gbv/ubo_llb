...
<!--       </language> -->
      <li class="nav-item dropdown ml-auto mir-lang">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" title="{i18n:translate('llb.layout.changeLanguage')}">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-6 col-md-auto">
            <a href="https://www.llb-detmold.de/" id="llbLogo" class="containsimage">
              <span>
          ...
          <div class="col-12 col-sm-6 col-md-auto">
            <div id="orgaunitTitle">
              <a href="{$WebApplicationBaseURL}">
                <h1>
                  <xsl:value-of select="i18n:translate('llb.ubo')" />
                </h1>
              </a>
            </div>
          </div>
          <div class="col-12 col-md">
            <form action="{$WebApplicationBaseURL}servlets/solr/select" class="searchfield_box form-inline my-2 my-lg-0" role="search">
              <div class="input-group mb-3">
                <input id="searchInput" class="form-control mr-sm-2 search-query" type="search" name="qq" placeholder="{i18n:translate('llb.layout.searchPublications')}" aria-label="{i18n:translate('llb.layout.searchPublications')}" />
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
          ...
          <button class="navbar-toggler" type="button"
            ...
            aria-controls="mir-main-nav-collapse-box" aria-expanded="false" aria-label="{i18n:translate('llb.layout.toggleNavigation')}">
    ...
    <nav class="rootline" aria-label="breadcrumb">
      <ol class="breadcrumb py-1" vocab="http://schema.org/" typeof="BreadcrumbList">
        <li class="breadcrumb-item" property="itemListElement" typeof="ListItem">
          <a href="https://www.llb-detmold.de/" property="item" typeof="WebPage">
            <i class="fas fa-home mr-2" />
            <xsl:text>LLB</xsl:text>
          </a>
        </li>
        <li class="breadcrumb-item" property="itemListElement" typeof="ListItem">
          ...
          <div class="row">
            ...
            <div class="col col-md-auto justify-content-end">
              ...
              <div id="footerCopyright" class="navbar">
                <ul class="nav">
                  <li>
                    <xsl:value-of select="i18n:translate('llb.layout.copyright')" />
                  </li>
                  <li>
                    <a href="mailto:{i18n:translate('llb.contact.mail')}" class="footer-menu__entry">
                      <i class="fas fa-fw fa-envelope" />
                      <xsl:value-of select="i18n:translate('llb.contact.mail')" />
                    </a>
                  </li>
                </ul>
              </div>
